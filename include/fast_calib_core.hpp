 ...
 * extrinsic calibration. It provides the core algorithms for detecting calibration
 * targets in both sensor modalities and computing the rigid transformation between them.
 * 
 ...
 *     std::cout << "Calibration RMSE: " << calib_result.rmse << " m" << std::endl;
